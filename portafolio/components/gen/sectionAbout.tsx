      ...
      <div className="text-gray-300 flex justify-center mt-30 h-12 "><a href="/assets/Brayan_Ribero_CV_IT_Eng.pdf" download>
        {showButton && (
          <motion.button
            ...
            className="border-2 border-gray-400 px-8 py-2 rounded-md cursor-pointer transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-blue-500/50 hover:border-transparent tracking-[.15em]"
          >
            CV
          </motion.button>
        )}
