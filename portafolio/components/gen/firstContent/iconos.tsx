    ...
    return(
        <div>
            ...
            <div className='flex pt-7 mt-10 mb-15 lg:mt-0 lg:mb-0'>
                <a href="https://github.com/bryanribero" target='_blank'><img src="/icons/icons8-github.svg" alt="GitHub" className='w-10 opacity-40 transition-all duration-300  hover:opacity-80 cursor-pointer hover:scale-125 mr-20 lg:mr-0 '/></a>
                ...
                <a href="mailto:bryanribero@hotmail.com"><img src="/icons/icons8-ms-outlook.svg" alt="OutLook" className='w-10 opacity-40 transition-all duration-300  hover:opacity-80 cursor-pointer hover:scale-125 ml-20 lg:ml-0' /></a>
            </div>
        </div>
    );
}
